...
export default function Sidebar({
  ...
  return (
    <div className="flex flex-col h-full relative">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-0.5">
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded-md text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors duration-150"
            >
            ...
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded-md text-slate-400 hover:text-red-500 hover:bg-red-50 transition-colors duration-150"
            >
        ...
        {searchOpen && (
          <div className="relative mb-2">
            <input
              ...
              className="w-full h-7 pl-3 pr-7 rounded-lg border border-slate-200 bg-slate-50 text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors duration-150"
            />
            {searchQuery && (
              <button
      ...
      {/* Footer */}
      <div className="flex-shrink-0 px-4 py-2.5 border-t border-slate-100">
      ...
      {confirmClear && (
        <div className="absolute inset-0 z-10 flex items-end bg-white/80 backdrop-blur-sm">
          <div className="w-full bg-white border-t border-slate-200 shadow-xl p-4 rounded-t-xl">
...
function SidebarEmpty({ hasHistory }) {
  return (
    <div className="flex flex-col items-center justify-center py-10 px-3 text-center">
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" className="text-slate-300 mb-2" aria-hidden="true">
      ...
      <p className="font-semibold text-slate-500 text-xs" style={{ fontFamily: '"DM Sans", sans-serif' }}>
